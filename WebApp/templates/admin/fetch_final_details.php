<?php
     ...
     echo "<select name='module-id' required>";
     while($row = mysqli_fetch_array($find))
     {
        echo "<option value=$row[id] name='module-id' selected>$row[name]</option>";
     }
     echo "</select> <br>";
     ...
     echo "<br><input type='submit' value='Update' name='update-set-button'>";
     exit;
?>   